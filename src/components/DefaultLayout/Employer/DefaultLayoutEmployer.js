...
import { urlLoginEmployer, webConfig, stateSite } from '../../../GlobalConfig';
...
// sidebar nav config
import navigation from '../../../_navAreaEmployer';
// routes config
...
const nameComponent = 'DefaultLayoutEmployer';
                                ...
                                {routes.map((route, idx) => {
                                    ...
                                    <Route 
                                        ...
                                        render={props => {
                                            ...
                                            if(this.state.tokenResult && claimsToken && claimsToken.role && claimsToken.role.includes("Company")){
                                                return(
                                                    <route.component 
                                                    {...props} 
