    ...
    UNSAFE_componentWillReceiveProps(nextProps, nextState) {
       ...
       if(this.props.postulant !== nextProps.postulant){
            ...
            if(postulant !== null){
				...
				//console.log(`${webConfig.urlImagesNotCache}/${postulant.urlImagen}`);

                this.setState({altAvatarImg: postulant.email});
                
				this.setState(
				{
					nameContactPerson: postulant.nombrePersona + " " + postulant.apellidoPersona + " | " + postulant.email,
					urlImgAvatar: `${webConfig.urlImagesNotCache}/${postulant.urlImagen}`
				});
      ...
      <React.Fragment>
        ...
        <Nav className="d-md-down-none" navbar>
          <NavItem className="px-3">
            <Link to="/area/postulante/dashboard">Dashboard</Link>
          </NavItem>
          <NavItem className="px-3">
            <Link to="/area/postulante/miCV">Mi CV</Link>
          </NavItem>
          <NavItem className="px-3">
            <Link to="/area/postulante/ofertas">Ofertas</Link>
          </NavItem>
          <NavItem className="px-3">
            <Link to="/area/postulante/postulaciones">Postulaciones</Link>
          </NavItem>
        </Nav>
        <Nav className="ml-auto" navbar>
          ...
          <AppHeaderDropdown direction="down">
            ...
            */}
              ...
              src={[this.state.urlImgAvatar, avatar1]}
