...
import { CreateJobOfferValidation, RulesValidation } from './ValidationsRules/CreateJobOfferValidation';
...
class CreaterJobOffer extends Component {
    ...
    UNSAFE_componentWillReceiveProps(nextProps, nextState){
        ...
        const { countries, regions, communes, employmentCategories, professions, educationalLevel, idioms, typesContracts, typesSalaries, typesPaymentPeriodicity, jobsOffersList, resultJobOfferCreated} = nextProps;
        ...
        if(nextProps.dataEmployer && nextProps.dataEmployer !== this.state.dataEmployer){
    ...
    componentDidMount(){
        ...
        if(idJobOffer){  
            this.props.getJobsOffers({ id: idJobOffer, pageSize: 1, pageIndex: 0, keySearch: "", bShowDisableRegisters: null });
        }
        else{
    ...
    previewJobOffer = (e) => {
        ...
        console.log(`${webConfig.urlImages}/${this.state.dataEmployer.employer.rutaLogoEmpresa}`);
        const content = 
            <CustomJobOfferPreview dataForm={{
                ...
                urlImgAvatar: `${webConfig.urlImages}/${this.state.dataEmployer.employer.rutaLogoEmpresa}`,
                puesto: puesto,
        ...
        <>
            ...
            <Formik
                ...
                validate={ (values) => {
                    ...
                    RulesValidation({ values, errors, state: {...this.state}});
