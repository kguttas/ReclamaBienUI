...
import { isIterable, FormatDateFromInput } from '../../../utiles';
...
class RegisterPostulant extends Component{
    ...
    UNSAFE_componentWillReceiveProps(nextProps, nextState){
        ...
        const { countries, regions, communes } = nextProps;
        ...
        if(nextProps.newUser !== this.props.newUser){
            ...
            const { codeErrors, bUserCreated } = nextProps.newUser;
...
/*
                ...
                onSubmit={(values, { setSubmitting }) => {
                    ...
                    this.props.createUserPostulant(values);
                   // console.log(values);
                    setTimeout(() => {
                ...
                {({
                    ...
                    <FormFormik onSubmit={handleSubmit}>
                        ...
                        <Row>
                            <Col xs="12">
                                <Button block color="success" type="submit" disabled={isSubmitting} onClick={this.validateForm} >REGISTRAR POSTULANTE</Button>
                            </Col>
                        </Row>
                    </FormFormik>
                    );
            ...
            <Row>
                <Col>
                    ...
                    <CardHeader>
                        ...
                        <strong>Postulante Registrado</strong>
                        <div className="card-header-actions">
                            <a href="/#/login/postulante" rel="noreferrer noopener" className="card-header-action">
                                <small className="text-muted">login postulante</small>
                            </a>
                        </div>
                    </CardHeader>
                    <CardBody>
