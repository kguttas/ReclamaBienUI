...
import { urlAreaAdmin, webConfig, urlRecoveryPassword } from '../../GlobalConfig';
import { Formik, Form as FormFormik } from 'formik';
import cookie from 'react-cookies';
import CustomModal from '../../components/UI/CustomModal';
// Redux
import { connect } from 'react-redux';
import { loginAdmin } from '../../actions/usersActions';
    ...
    UNSAFE_componentWillReceiveProps(NextProps, NextState){
        ...
        if(this.props.token !== NextProps.token){
            ...
            if(NextProps.token.access_token){
                ...
                this.props.history.push(urlAreaAdmin);
            }else{
        ...
        if(token){
            ...
            if(jwtParts[1]){
                ...
                if(decodedString){
                    ...
                    if(claimsToken.role.includes('Admin')){
                        this.props.history.push(urlAreaAdmin);
                    }
                }
            }
