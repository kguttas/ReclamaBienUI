...
import { urlAreaEmployer, webConfig, urlRecoveryPassword } from '../../GlobalConfig';
import { Formik, Form as FormFormik } from 'formik';
import cookie from 'react-cookies';
import CustomModal from '../../components/UI/CustomModal';
// Redux
import { connect } from 'react-redux';
import { loginEmployer } from '../../actions/usersActions';
...
class LoginEmployer extends Component {
        ...
        if(token){
            ...
            if(jwtParts[1]){
                ...
                if(decodedString){
                    ...
                    if(claimsToken.role.includes('Company')){
                        this.props.history.push(urlAreaEmployer);
                    }
                }
            }
    ...
    render() {
        ...
        <div>
            <h2>Registrarse</h2>
            <p>Publica y gestiona ofertas de empleo como <strong>empresa</strong> o <strong>persona natural</strong>, y accede a un set completo de funcionalidades que te ayudaran en tus tareas de selección de talento.</p>
            <Link to="/registrarse/empleador">
                                            ...
                                            <CardBody>
                                                <Formik
                                                    ...
                                                    onSubmit={(values, { setSubmitting ,resetForm }) => {
                                                        ...
                                                        this.props.loginEmployer(values);
                                                        //values.password = '';
                                                        setSubmitting(false); 
                                                    ...
                                                    <Row className="d-xs-block d-sm-block  d-md-block d-lg-none d-xl-none mt-3">
                                                        <Col xs="12">
                                                            <Card className="text-white bg-dark py-5">
